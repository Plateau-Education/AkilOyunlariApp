...
class SudokuGenerator:
    ...
    def generate_puzzle_for_difficulty(self, lower_target=0.3, upper_target=0.5, max_tries = 100, by_box=False, by_box_kwargs={}):
        for i in range(max_tries):
            ...
            if ((d and not lower_target) or (d.value > lower_target and not upper_target) or (d.value < upper_target)):
                return puz, d
            else:
                return None, None
...
class SudokuMaker:
    ...
    def __init__(self,
                  generator_args={'clues':27,'group_size': 9},
