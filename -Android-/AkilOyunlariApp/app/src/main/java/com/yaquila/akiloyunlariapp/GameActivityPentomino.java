...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(difficulty.equals("Easy") || difficulty.equals("Kolay")){
            setContentView(R.layout.activity_game_pentomino_easy);
//            gridSize=5;
        }

//        else if(difficulty.equals("Medium") || difficulty.equals("Orta")){
//            setContentView(R.layout.activity_game_pentomino_medium);
////            gridSize=8;
//        }
//        else{
//            setContentView(R.layout.activity_game_pentomino_hard);
////            gridSize=10;
//        }

//        GridLayout gridLayout = findViewById(R.id.gridGL_ga);
//        gridLayout.view
        final RelativeLayout relativeLayout = (RelativeLayout) findViewById(R.id.gridGL_ga).getParent();
        relativeLayout.removeAllViews();
        LayoutInflater inflater = getLayoutInflater();
        @SuppressLint("InflateParams")
        GridLayout gridLayout = (GridLayout) inflater.inflate(R.layout.pentomino_46,null);
