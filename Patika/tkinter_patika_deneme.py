                    ...
                    if (
                        ...
                        if sol_dolu:
                            if rc in sag_cizgi:
                                if (
                                    current == yukari
                                ):  # yukarısıyla birleşirse kapalı alan oluşturucak
                                    asagi_cizgi.append(
                                        rc
                                    )  # şuanki bloğa asagi_cizgi eklendi
                                    yukari_cizgi.append(
                                        asagi
                                    ...
                                    current == asagi
                                ):  # asagisiyla birleşirse kapalı alan oluşturacak
                                    yukari_cizgi.append(
                                        rc
                                    )  # şuanki bloğa yukari_cizgi eklendi
                                    asagi_cizgi.append(
                                        yukari
                                ...
                                if (
                                    current == sag
                                ):  # sagdakiyle birleşirse kapalı alan oluşturucak
                                    asagi_cizgi.append(
                                        rc
                                    )  # şuanki bloğa asagi_cizgi eklendi
                                    yukari_cizgi.append(
                                ...
                                if (
                                    ...
                                    sag_cizgi.append(
                                        rc
                                    )  # şuanki bloğa sag_cizgi eklendi
                                    sol_cizgi.append(
                                        sag
                                ...
                                if (
                                    ...
                                    current == yukari
                                ):  # yukarisiyla birleşirse kapalı alan oluşturacak
                                    sag_cizgi.append(
                                        rc
                                    )  # şuanki bloğa sag_cizgi eklendi
                                    sol_cizgi.append(
                            ...
                            if rc in sol_cizgi:
                                ...
                                if (
                                    current == sol
                                ):  # soldakiyle birleşirse kapalı alan oluşturucak
                                    asagi_cizgi.append(
                                        rc
                                    )  # şuanki bloğa asagi_cizgi eklendi
                                    yukari_cizgi.append(
                                    ...
                                    sol_cizgi.append(
                                        rc
                                    )  # şuanki bloğa sol_cizgi eklendi
                                    sag_cizgi.append(
                                        sol
                            ...
                            if rc in sol_cizgi:
                                if (
                                    current == sag
                                ):  # sagla birleşirse kapalı alan oluşturucak
                                    asagi_cizgi.append(
                                        rc
                                    )  # şuanki bloğa asagi_cizgi eklendi
                                    yukari_cizgi.append(
                                ...
                                if (
                                    ...
                                    current == sag
                                ):  # sagiyla birleşirse kapalı alan oluşturacak
                                    sol_cizgi.append(
                                        rc
                                    )  # şuanki bloğa sol_cizgi eklendi
                                    sag_cizgi.append(
                            ...
                            if rc in sol_cizgi:
                                if (
                                    ...
                                    current == yukari
                                ):  # yukarısıyla birleşirse kapalı alan oluşturacak
                                    sag_cizgi.append(
                                        rc
                                    )  # şuanki bloğa sag_cizgi eklendi
                                    sol_cizgi.append(
                                ...
                                if (
                                    ...
                                    current == sag
                                ):  # sağıyla birleşirse kapalı alan oluşturacak
                                    sol_cizgi.append(
                                        rc
                                    )  # şuanki bloğa sol_cizgi eklendi
                                    sag_cizgi.append(
